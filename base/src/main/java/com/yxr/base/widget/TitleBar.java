...
import com.yxr.base.util.ScreenUtil;
...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        Drawable drawable = getResources().getDrawable(R.drawable.titlebar_return_icon_black);
        drawable.setBounds(0, 0, mOutPadding * 4, mOutPadding * 4);
        setLeftImageResource(drawable);
    ...
    public void setImmersive(boolean immersive) {
        ...
        if (mImmersive) {
            mStatusBarHeight = ScreenUtil.getStatusBarHeightWithTranslucentStatus(getContext());
        } else {
            mStatusBarHeight = 0;
        }
